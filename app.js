...
function home(){
  shell(`<main class="ct-home-dark">
    ...
    <section class="ct-registration-grid">
      <button class="ct-registration-card ct-reg-team" data-register="team"><div class="ct-reg-icon">👥</div><div><h2>TEAM REGISTRATION</h2><p>Register your cricket team and create your secure Team ID.</p><strong>REGISTER TEAM →</strong></div></button>
      <button class="ct-registration-card ct-reg-tournament" data-register="tournament"><div class="ct-reg-icon">🏆</div><div><h2>TOURNAMENT REGISTRATION</h2><p>Register your tournament and create your secure Tournament ID.</p><strong>REGISTER TOURNAMENT →</strong></div></button>
    </section>
